...
<div class="row">
    <div class="col-md-12">
        <h2 class="page-header"><i class="fa fa-list"></i> Danh sách website đã tạo</h2>
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $key => $vals): ?>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;" class="edit"><i class="fa fa-pencil"></i> Sửa</a>
                                <a href="javascript:;"  style="color: #F55E53;" class="delete"><i class="fa fa-remove"></i> Xóa</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
